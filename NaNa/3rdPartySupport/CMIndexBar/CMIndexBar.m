...
- (id)initWithFrame:(CGRect)frame 
{
    if ((self = [super initWithFrame:frame])) 
    {
		...
		self.highlightedBackgroundColor = [UIColor colorWithRed:135/255.0 green:135/255.0 blue:135/255.0 alpha:0.3];
    }
    return self;
}
...
{	
	...
	for (i=0; i<[indexes count]; i++)
	{
        ...
        NSDictionary * dict = [indexes objectAtIndex:i];
        NSString *lowerCase = [[dict objectForKey:@"cityType"] description];
        alphaLabel.text = [NSString stringWithFormat:@"%@",[lowerCase uppercaseString]];
		alphaLabel.font = [UIFont fontWithName:@"Helvetica" size:12.0];	
